...
Object.assign(translations.fr, {
  ...
  p13Context: "Stage ingénieur · DOGA FZ · Tanger Free Zone",
  p13Title: "Digitalisation de la Performance Industrielle — DOGA FZ (Stage)",
  p13Text: "Développement full-stack d'une application Flask/SQLAlchemy de reporting départemental couvrant 5 métiers (assemblage, usinage, peinture, métrologie, plasturgie), avec exports Excel automatisés, calcul de 15+ KPI qualité et recommandations Odoo/Power BI.",
  p13R1: "départements",
  p13R2: "KPI qualité",
  p13Details: "Application déployée en contexte réel chez DOGA FZ (filiale du Groupe DOGA France, certifiée ISO 9001). Le rapport documente les formulaires adaptatifs par métier, le moteur de calcul des KPI avec codage couleur automatique, ainsi que la structuration documentaire et les procédures d'onboarding.",
  p14Context: "Projet académique · Conception Orientée Produit Avancé",
  p14Title: "Conception Avancée & ACV d'une Trottinette Électrique — Projet COPA",
  p14Text: "Désassemblage complet, caractérisation des matériaux et nomenclature d'une trottinette WISPEED T855, puis simulation Eco-Audit sur Ansys Granta EduPack pour quantifier l'empreinte carbone totale (209 kg CO\u2082) et identifier les leviers d'éco-conception.",
  p14R1: "kg CO\u2082 sur 4 ans",
  p14R2: "MJ d'énergie",
  p14Details: "L'analyse révèle que la fabrication représente 51,6 % de l'énergie et 57,7 % des émissions CO\u2082. Le recyclage des alliages métalliques en fin de vie permettrait d'économiser -696 MJ et -55,9 kg CO\u2082. Le rapport propose des substitutions matériaux et une conception orientée désassemblage (DfD).",
  p15Context: "Projet académique · ingénierie environnementale",
  p15Title: "Système Modulaire de Recyclage des Eaux Grises (MGWS)",
  p15Text: "Conception d'un système de traitement et recyclage des eaux grises en boucle fermée : dimensionnement des filières (filtration, traitement biologique, désinfection UV), intégration de capteurs intelligents et architecture de télésurveillance temps réel.",
  p15Impact: "Filtration + biologique + UV \u2022 capteurs pH/turbidité \u2022 monitoring IoT",
  p15Details: "Le système MGWS est directement transposable aux systèmes de support-vie (ECLSS) des stations spatiales et modules habités. Le rapport détaille le dimensionnement scientifique, la sélection des capteurs et l'alimentation énergétique autonome du dispositif.",
  p16Context: "Projet académique · mathématiques appliquées",
  p16Title: "Régression Linéaire & Modélisation Numérique — MINA",
  p16Text: "Implémentation from scratch d'un algorithme de régression linéaire multiple en Python/NumPy, avec résolution par moindres carrés, validation croisée et analyse des résidus pour la prédiction de performances de procédés industriels.",
  p16Impact: "Moindres carrés \u2022 validation croisée \u2022 résidus",
  p16Details: "Ce projet complète l'algorithme d'Uzawa (P.05) dans le cadre du module MINA. Le rapport présente la théorie des moindres carrés, l'implémentation matricielle et les tests de validation sur jeux de données techniques.",
  p17Context: "Projet académique · mécanique physique",
  p17Title: "Modélisation Mécanique & Résistance des Matériaux — MP1",
  p17Text: "Étude complète de mécanique physique couvrant la cinématique, la dynamique du solide, la résistance des matériaux et les critères de dimensionnement, avec résolution analytique et numérique des cas de charge complexes.",
  p17Impact: "Cinématique \u2022 dynamique \u2022 RDM \u2022 dimensionnement",
  p17Details: "Le rapport couvre les fondamentaux de la mécanique du solide indéformable et déformable, avec applications aux systèmes mécaniques articulés et aux structures soumises à des sollicitations combinées (flexion, torsion, cisaillement).",
  moreProjectsButton: "Voir les 14 autres projets",
  lessProjectsButton: "Masquer les 9 autres projets",
  moreProjectsSummary: "Voir les 14 autres projets académiques",
  ...
  media1Alt: "Cérémonie d'ouverture du Hult Prize à Arts et Métiers Rabat",
  ...
  media1Title: "Hult Prize : Cérémonie d'ouverture et lancement du programme",
  media1Text: "En tant que Campus Director, j’ai supervisé cet événement réunissant les participants pour le lancement officiel de la compétition d'entrepreneuriat social.",
  ...
  jobDatingGroupLabel: "Entrepreneuriat social · Campus Director",
...
Object.assign(translations.en, {
  ...
  media1Alt: "Hult Prize Opening Ceremony at Arts et Métiers Rabat",
  ...
  media1Title: "Hult Prize: Opening Ceremony and Program Launch",
  media1Text: "As Campus Director, I supervised this event gathering participants for the official launch of the social entrepreneurship competition.",
  ...
  jobDatingGroupLabel: "Social Entrepreneurship · Campus Director",
